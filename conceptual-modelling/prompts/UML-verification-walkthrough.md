# UML Class Diagram Verification — Interactive Walkthrough

Verify the internal quality of a UML class model and discuss the findings through an interactive walkthrough.
