...
In the section at the bottom, you will find a business modelling exercise. 
The exercise is about creating an EPC model based on a scenario.  

You should give feedback on the solution. In particular, you should identify any weaknesses of the solution. 
For this, you should use the EPC verification criteria in the section below.
...
- Check that the model is aligned with the exercise text.
